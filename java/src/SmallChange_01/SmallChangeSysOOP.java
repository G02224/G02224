...
public class SmallChangeSysOOP {
    ...
    public void menu() {//显示菜单
        do{
            ...
            key =scanner.nextInt();
            switch (key){
                case 1: this.datail();break;
                case 2:this.incant();break;
                case 3:this.pay();break;
                case 4:this.lookmonoey();break;
                case 5:this.beark();break;
                default:
    ...
    public void datail() {//零钱通明细
        System.out.println(details);
    }

    public void incant() {//充值金额
        System.out.println("--------注意事项:充值金额单笔充值最高一万元RMB--------");
        System.out.print("输入充值金额：");
        money = scanner.nextDouble();
        if (money <= 0 || money > 10000) {
            System.out.println("充值失败");
            System.out.println("充值金额必须在1-10000元之间");
            return;
        }
        balance += money;
        date = new Date();
    ...
    public void beark() {//退出程序
        ...
        while (true){
            ...
            System.out.println("------程序已继续运行中------");return;
        }
    }
}
